        ...
        this.recvFun("methodCanary", [
            {
                ...
                methodEvents: [
                    {stack: 1, start: 100, end: 102, className: "classA", methodName: "methodA", desc: "descA"},
                    {stack: 1, start: 104, end: 112, className: "classB", methodName: "methodB", desc: "descB"},
                    {stack: 2, start: 105, end: 107, className: "classC", methodName: "methodC", desc: "descC"},
                    {stack: 2, start: 107, end: 110, className: "classD", methodName: "methodD", desc: "descD"},
                    {stack: 3, start: 107, end: 108, className: "classE", methodName: "methodE", desc: "descE"},
                ]
            },
            {
                threadInfo: {
                ...
                methodEvents: [
                    {stack: 1, start: 90, end: 107, className: "classA", methodName: "methodA", desc: "descA"},
                    {stack: 1, start: 108, end: 124, className: "classB", methodName: "methodB", desc: "descB"},
                    {stack: 2, start: 103, end: 104, className: "classC", methodName: "methodC", desc: "descC"},
                    {stack: 2, start: 106, end: 120, className: "classD", methodName: "methodD", desc: "descD"},
                    {stack: 3, start: 107, end: 108, className: "classE", methodName: "methodE", desc: "descE"},
                ]
            }
        ]);
